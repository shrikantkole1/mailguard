                        ...
                        <div className="space-y-5">
                            ...
                            <div className="grid grid-cols-12 gap-5">
                                    ...
                                    <div className="bg-white rounded-2xl p-5 shadow-sm border border-black/5">
                                        ...
                                        {!connectedEmail ? (
                                            <div className="flex flex-col items-center justify-center space-y-4 py-8">
                                                <div className="w-16 h-16 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl flex items-center justify-center mb-2">
                                                    <Mail className="w-8 h-8 text-blue-400" />
                                                </div>
                                                <p className="text-xs text-gray-600 font-medium text-center">Connect your Google account<br />to scan emails automatically</p>
                                                <motion.button
                                                    whileHover={{ scale: 1.02 }}
                                                    whileTap={{ scale: 0.98 }}
                                                    onClick={() => login()}
                                                    className="flex items-center gap-2 px-5 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-xl transition-all shadow-lg shadow-blue-500/25 font-semibold text-sm"
                                                >
                                                ...
                                                <p className="text-[10px] text-gray-400">Secure OAuth 2.0 authentication</p>
                                            </div>
                                ...
                                <div className="col-span-5 space-y-4">
                                    {!verdict && !isAnalyzing && !analysisError && (
                                    ...
                                    {analysisError && !isAnalyzing && (
                                        <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} className="bg-gradient-to-r from-red-500 to-rose-600 rounded-2xl p-6 text-white shadow-lg">
                                            <div className="flex items-start gap-4">
                                                <div className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center flex-shrink-0">
                                                    <AlertTriangle className="w-6 h-6" />
                                                </div>
                                                <div className="flex-1">
                                                    <h3 className="text-lg font-heading font-bold mb-1">Analysis Failed</h3>
                                                    <p className="text-sm text-white/90">{analysisError}</p>
                                                    <button
                                                        onClick={() => setAnalysisError(null)}
                                                        className="mt-3 px-4 py-2 bg-white/20 hover:bg-white/30 rounded-lg text-sm font-semibold transition-colors"
                                                    >
                                                        Dismiss
                                                    </button>
                                                </div>
